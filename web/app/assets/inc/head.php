<head>
    ...
    <title>Vivências em Nutrição - CFN</title>

    <meta content="Este é o espaço para que nutricionistas de todo o país demonstrem como a nossa profissão pode contribuir para melhorar a vida da população brasileira" name="description">

    <meta content="CFN, Conselho Federal de Nutricionistas, Nutrição, Nutricionistas" name="keywords">

    <meta property="og:title" content="Vivências em Nutrição - CFN">
    <meta property="og:site_name" content="Vivências em Nutrição - CFN">
